...
def main():
    parser = argparse.ArgumentParser(description="Create subject-level IEEE ADHD EEG splits without leakage.")
    parser.add_argument("--raw-dir", default="data_raw", help="Directory containing raw IEEE .mat files.")
    parser.add_argument("--output-dir", default="IEEE_subject_split", help="Directory to store subject-level train/val/test .pt files.")
    ...
    metadata = {
        "name": "IEEE subject-level EEG data for ADHD / Control children",
        "description": "Subject-level split performed before windowing to avoid subject leakage.",
        "license": "CC BY 4.0",
